...
final class ThirdViewController: BaseViewController {
    ...
    private let introLabel: OnboardingLabel = {
        let label = OnboardingLabel(text: "SeSAC Study", textFont: SSFonts.body1M16.fonts, textHighlightened: "", textHLenedFont: SSFonts.body1M16.fonts, size: 24, lineHeight: SSFonts.display1R20.lineHeight)
        return label
    }()
